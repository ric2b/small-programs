###NOTE: A config.txt file is required, as well as files for the rotors (can use the same for all rotors). The plugboard is optional (no plugboard is the civilian version).
